<?php /* Smarty version Smarty-3.1.19, created on 2020-06-14 04:46:03
         compiled from "C:\xampp\htdocs\beauty-server\app\views\shop\edit_shop.html" */ ?>
<?php /*%%SmartyHeaderCode:18603116005edcf73f92f832-38612166%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0361bee1114cf4ac5e06deb73cca3c15051b1c6c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\beauty-server\\app\\views\\shop\\edit_shop.html',
      1 => 1592019591,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18603116005edcf73f92f832-38612166',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5edcf73f9f3376_95668666',
  'variables' => 
  array (
    'data' => 0,
    '_admin' => 0,
...
<?php if ($_valid && !is_callable('content_5edcf73f9f3376_95668666')) {function content_5edcf73f9f3376_95668666($_smarty_tpl) {?><title><?php echo translate('商家管理');?>
 - <?php echo translate('编辑商家');?>
 </title>
<div class="page-header">
	<h1>
		<?php echo translate('商家管理');?>
 <small> <i class="ace-icon fa fa-angle-double-right"></i> <?php echo translate('编辑商家');?>
...
<div class="main">
    <ul class="nav nav-tabs">
        ...
        <li><a href="/admin_system#page/admin_shop/"><?php echo translate('商家列表');?>
</a></li>
        <?php }?>
        <li class="active"><a href="/admin_system#page/admin_shop/edit/<?php echo $_smarty_tpl->tpl_vars['data']->value->id;?>
"><?php echo translate('编辑商家');?>
</a></li>
    </ul>
  ...
  <div class="panel panel-default">
        ...
        <?php if ($_smarty_tpl->tpl_vars['_admin']->value->_role_type==0||$_smarty_tpl->tpl_vars['_admin']->value->_role_type==1||$_smarty_tpl->tpl_vars['_admin']->value->id!=$_smarty_tpl->tpl_vars['data']->value->id) {?>
...
" autocomplete="new-password" class="form-control input-width"  maxlength="100" />
					</span>
				</div>
...
:</label>
				<div class="col-xs-12 col-sm-5">
					<span class="block">
						<input id="password" type="password" name="password" class="form-control input-width" autocomplete="new-password" maxlength="100" /> 
					</span>
				</div>
...
:</label>
                <input type="hidden" name="_status" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->status;?>
" />
				<div class="col-xs-12 col-sm-5">
					<span class="block"  > <label>
							<input type="radio" name="status" value="1" <?php if ($_smarty_tpl->tpl_vars['data']->value->status==1) {?>
							checked="checked" <?php }?> > <?php echo translate('正常');?>
 </label> &nbsp;&nbsp;&nbsp;<label>
							<input type="radio" name="status" value="0" <?php if ($_smarty_tpl->tpl_vars['data']->value->status==0) {?>
							checked="checked" <?php }?> ><?php echo translate('禁用');?>
 </label> &nbsp;&nbsp;&nbsp;<!--<label>
							<input type="radio" name="status" value="2" <?php if ($_smarty_tpl->tpl_vars['data']->value->status==2) {?>
							checked="checked" <?php }?> >已禁用 </label>--> </span>
				</div>
...
:</label>
				<div class="col-xs-12 col-sm-5">
					<span class="block"  > <label>
						<input type="radio" name="business_status" value="0" <?php if ($_smarty_tpl->tpl_vars['data']->value->business_status==0) {?>
							checked="checked" <?php }?> ><?php echo translate('营业');?>
 </label> &nbsp;&nbsp;&nbsp;
							<input type="radio" name="business_status" value="1" <?php if ($_smarty_tpl->tpl_vars['data']->value->business_status==1) {?>
							checked="checked" <?php }?> > <?php echo translate('关闭');?>
 </label> &nbsp;&nbsp;&nbsp;<label>
							<!--<label>
							<input type="radio" name="status" value="2" <?php if ($_smarty_tpl->tpl_vars['data']->value->status==2) {?>
							checked="checked" <?php }?> >已禁用 </label>--> </span>
...
" value="1"  <?php if ($_smarty_tpl->tpl_vars['_week']->value[$_smarty_tpl->tpl_vars['k']->value]==1) {?>checked="checked"<?php }?> /><?php echo $_smarty_tpl->tpl_vars['v']->value;?>
           ...
           <!-- <div class="form-group _status_memo" style="display:<?php if ($_smarty_tpl->tpl_vars['data']->value->status!=2) {?>none<?php }?>">
				<label for="title" class="col-xs-12 col-sm-3 control-label no-padding-right">审核说明:</label>
				<div class="col-xs-12 col-sm-5">
					<span class="block">
						<input type="text" name="_status_memo" value="" class="form-control input-width" />
					</span>
				</div>
				<div class="help-block inline">* 请填写审核失败原因</div>
			</div>-->
<script>
$(function(){
...
:</label>
				<div class="col-xs-12 col-sm-5">
					<span class="block">
						<input id="money" type="text" name="money" min="0" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->money;?>
" class="form-control input-width" />
			...
			<?php if ($_smarty_tpl->tpl_vars['_admin']->value->_role_type==0||$_smarty_tpl->tpl_vars['_admin']->value->_role_type==1) {?>
            <div class="form-group">
...
"  <?php if (in_array($_smarty_tpl->tpl_vars['v']->value['title'],translate($_smarty_tpl->tpl_vars['data']->value->keywords))) {?>checked="checked"<?php }?> /><?php echo $_smarty_tpl->tpl_vars['v']->value['title'];?>
...
:</label>
                <div class="col-xs-12 col-sm-5">
					<span class="block">
						<input id="name" type="text" name="name" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->name;?>
" class="form-control input-width"  />
					</span>
                </div>
                <div class="help-block inline"></div>
...
:</label>
				<div class="col-xs-12 col-sm-5">
			<span class="block">
				<label> <input type="radio" name="city_type" class="city_type" value="1" <?php if ($_smarty_tpl->tpl_vars['data']->value->city_type==1) {?>checked="checked" <?php }?>> <?php echo translate('中国');?>

					</label> &nbsp;&nbsp;&nbsp;<label> <input type="radio" class="city_type" name="city_type" value="2" <?php if ($_smarty_tpl->tpl_vars['data']->value->city_type==2) {?>checked="checked" <?php }?>> <?php echo translate('日本');?>
...
:</label>
				<div class="col-xs-12 col-sm-2">
					<span class="block">
						<input id="lat" type="text" name="lat" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->lat;?>
" class="form-control input-width" required />
					</span>
				</div>
				<div class="col-xs-12 col-sm-2">
					<span class="block">
						<input id="lng" type="text" name="lng" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->lng;?>
" class="form-control input-width" required />
					</span>
				</div>
                <div class="col-xs-12 col-sm-1">
   ...
   <!-- <div class="panel panel-info">
        <div class="panel-heading">
            商家资料
             ...
             <!--<div class="form-group">
				<label for="title" class="col-xs-12 col-sm-3 control-label no-padding-right">支付二维码:</label>
				<div class="col-xs-12 col-sm-5">
					<span class="block">
						<a href="/Index/qrcode?url=<?php echo $_smarty_tpl->tpl_vars['data']->value->qrcode;?>
" target="_blank"><img src="/Index/qrcode?url=<?php echo $_smarty_tpl->tpl_vars['data']->value->qrcode;?>
" width="100" /></a>
					</span>
				</div>
				<div class="help-block inline"></div>
...
,
				url: '/admin_shop/save_pwd<?php echo $_smarty_tpl->tpl_vars['qs_pid']->value;?>
',
				title: '修改密码',
				value: '',
...
");
        ...
        $("#saveedit").click(function(e) {
            ...
            if ($('#submitform').valid()) {
                ...
                if(!validate){
                    tooltipbox.alert("<?php echo translate('ユーザー名を半角、数字で入力してください。');?>
");
                    return false;
				}
...
");
                ...
                Dlc.service.post("/admin_shop/save/<?php echo $_smarty_tpl->tpl_vars['data']->value->id;?>
