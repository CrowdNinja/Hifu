<?php /* Smarty version Smarty-3.1.19, created on 2020-06-07 16:46:14
         compiled from "C:\xampp\htdocs\beauty-server\app\views\staff\reservation.html" */ ?>
<?php /*%%SmartyHeaderCode:21378692235edcfdb65957f1-30727691%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd5a0622e43613130c64964f830415c3cd91d3645' => 
    array (
      0 => 'C:\\xampp\\htdocs\\beauty-server\\app\\views\\staff\\reservation.html',
      1 => 1591541006,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21378692235edcfdb65957f1-30727691',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5edcfdb65fe0d9_21115528',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5edcfdb65fe0d9_21115528')) {function content_5edcfdb65fe0d9_21115528($_smarty_tpl) {?>
...
~<br/><?php echo formattime($_smarty_tpl->tpl_vars['v']->value['ctime']);?>
</td>
								<td><?php echo $_smarty_tpl->tpl_vars['v']->value['_parent_name'];?>
</td>
								<td><?php echo formattime($_smarty_tpl->tpl_vars['v']->value['ctime']);?>
...
" class="btn btn-success btn-xs"> <i class="fa fa-edit"></i>修改</a>
									<a href="admin_system#page/admin_staff/edit/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" class="btn btn-danger btn-xs">支払い完了</a><br/>
									<a href="admin_system#page/admin_staff/edit/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" class="btn btn-primary btn-xs">キャンセル・削除</a>
									<?php }?>
								</td>
							</tr>
							<?php } ?>
...
" type="button">
							...
							<?php if (chkcommand('/admin_staff/edit')) {?>
                            <a href="/admin_system#page/admin_staff/edit/" class="btn btn-complete"><i class="fa fa-plus-square-o"></i> 支払い完了</a>
							<?php }?>
						</td>
					</tr>
